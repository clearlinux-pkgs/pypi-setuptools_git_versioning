...
Source0  : https://files.pythonhosted.org/packages/a7/8f/46209c8d318017b3ebd9099dd6e3b7f59e9d89b11a1ccf00cd18f98cf4d7/setuptools-git-versioning-2.0.0.tar.gz
...
%prep
%setup -q -n setuptools-git-versioning-2.0.0
cd %{_builddir}/setuptools-git-versioning-2.0.0
pushd ..
cp -a setuptools-git-versioning-2.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712676763
