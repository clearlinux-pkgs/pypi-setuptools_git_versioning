...
Version  : 1.13.3
Release  : 4
URL      : https://files.pythonhosted.org/packages/22/87/806fa641c71265d0e8538fd58a9596700d5bf53ce8f2df3392c1a066276a/setuptools-git-versioning-1.13.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/22/87/806fa641c71265d0e8538fd58a9596700d5bf53ce8f2df3392c1a066276a/setuptools-git-versioning-1.13.3.tar.gz
...
%prep
%setup -q -n setuptools-git-versioning-1.13.3
cd %{_builddir}/setuptools-git-versioning-1.13.3
pushd ..
cp -a setuptools-git-versioning-1.13.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678805770
...
cp %{_builddir}/setuptools-git-versioning-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-setuptools_git_versioning/025b26602778c963abf48808009d93568263a377 || :
