...
Version  : 1.13.2
Release  : 3
URL      : https://files.pythonhosted.org/packages/5b/87/de216db8f99e2aac38215c1ef048a2716c805b4a58ce79a66c4a267140f4/setuptools-git-versioning-1.13.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/5b/87/de216db8f99e2aac38215c1ef048a2716c805b4a58ce79a66c4a267140f4/setuptools-git-versioning-1.13.2.tar.gz
...
%prep
%setup -q -n setuptools-git-versioning-1.13.2
cd %{_builddir}/setuptools-git-versioning-1.13.2
pushd ..
cp -a setuptools-git-versioning-1.13.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677516336
