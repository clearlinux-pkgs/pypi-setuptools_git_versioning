...
Version  : 1.13.6
Release  : 10
URL      : https://files.pythonhosted.org/packages/bf/04/1d84012444faab80b82fc358b03c20402dd7cefb697d2133d7cd6f8f996b/setuptools-git-versioning-1.13.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/bf/04/1d84012444faab80b82fc358b03c20402dd7cefb697d2133d7cd6f8f996b/setuptools-git-versioning-1.13.6.tar.gz
...
%prep
%setup -q -n setuptools-git-versioning-1.13.6
cd %{_builddir}/setuptools-git-versioning-1.13.6
pushd ..
cp -a setuptools-git-versioning-1.13.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706632721
